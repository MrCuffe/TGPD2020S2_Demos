# ADVENTURE CHOICE GAME by: Nishka Kesarwani
import time #Imports a module to add a pause between player's answer to situation and the consequences.

#Figuring out how users might respond with all possible options
answer_A = ["A", "a"]
answer_B = ["B", "b"]
answer_C = ["C", "c"]
...
#Objects which player can grab later on in the game
sword = 0
flower = 0

required = ("\nUse only A, B, or C\n") #Cutting down on duplication
#The story is broken into sections, starting with "intro"
#if else elif demonstrated below.
def intro():
